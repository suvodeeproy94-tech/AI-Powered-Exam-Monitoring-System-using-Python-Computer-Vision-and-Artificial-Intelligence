...
CSV_FIELDS = ["date", "time", "event_type", "alert_type", "description"]
...
class AlertManager:
    ...
    def fire(self, level, event_type, description, force=False):
        ...
        with self._lock:
            ...
            alert = Alert(level, event_type, description)
    ...
    def info(self, event_type, description, force=False):
        """Create an information alert."""
        return self.fire(AlertLevel.INFO, event_type, description, force)

    def warning(self, event_type, description, force=False):
        """Create a warning alert."""
        return self.fire(AlertLevel.WARNING, event_type, description, force)

    def critical(self, event_type, description, force=False):
        """Create a critical alert."""
        return self.fire(AlertLevel.CRITICAL, event_type, description, force)
